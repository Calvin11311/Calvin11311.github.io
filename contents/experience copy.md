...
- Solved key industry pain points: imprecise drag, poor consistency, and cumbersome workflows
...
**China Central Depository & Clearing (CCDC)** — *Beijing, China*  
*Technology R&D Department*  
Software Engineer &nbsp;|&nbsp; *Aug 2025 – Present*

- Deployed **Qwen3** open-source LLM for financial scenario applications
- Built a **RAG-based intelligent financial document analysis agent**, optimizing prompt engineering and knowledge base chunking
- Analyzed **30,000+** financial disclosure documents across 520 fields, improving accuracy from **64.2% → 87.6%** over baseline Qwen3-8B
...
- Achieved **118.59M params**, **10s** per image inference, **77.8%** reduction in computational cost vs. concurrent methods
...
- Certified by Huawei; showcased at Huawei Ascend AI Developer Conference main venue and official platforms
...
- Certified by CASIC Third Academy; deployed on key defense research projects
